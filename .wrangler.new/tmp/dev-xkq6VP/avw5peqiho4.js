...
// .wrangler/tmp/pages-Ac1UVe/bundledWorker-0.45268861495653234.mjs
...
var gt = /* @__PURE__ */ __name2((s) => {
  throw TypeError(s);
}, "gt");
var cs = /* @__PURE__ */ __name2((s, e, t) => e in s ? is(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t, "cs");
var E = /* @__PURE__ */ __name2((s, e, t) => cs(s, typeof e != "symbol" ? e + "" : e, t), "E");
var tt = /* @__PURE__ */ __name2((s, e, t) => e.has(s) || gt("Cannot " + t), "tt");
var h = /* @__PURE__ */ __name2((s, e, t) => (tt(s, e, "read from private field"), t ? t.call(s) : e.get(s)), "h");
var C = /* @__PURE__ */ __name2((s, e, t) => e.has(s) ? gt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(s) : e.set(s, t), "C");
var x = /* @__PURE__ */ __name2((s, e, t, r) => (tt(s, e, "write to private field"), r ? r.call(s, t) : e.set(s, t), t), "x");
var O = /* @__PURE__ */ __name2((s, e, t) => (tt(s, e, "access private method"), t), "O");
var ht = /* @__PURE__ */ __name2((s, e, t, r) => ({ set _(o) {
  x(s, e, o, t);
}, get _() {
  return h(s, e, r);
} }), "ht");
var pt = /* @__PURE__ */ __name2((s, e, t) => (r, o) => {
  let n = -1;
  return a(0);
  async function a(c) {
...
var ls = Symbol();
var us = /* @__PURE__ */ __name2(async (s, e = /* @__PURE__ */ Object.create(null)) => {
...
var Dt = /* @__PURE__ */ __name2((s) => {
  const e = s.split("/");
  return e[0] === "" && e.shift(), e;
}, "Dt");
var ms = /* @__PURE__ */ __name2((s) => {
  const { groups: e, path: t } = _s(s), r = Dt(t);
  return ys(r, e);
}, "ms");
var _s = /* @__PURE__ */ __name2((s) => {
  const e = [];
...
var bs = /* @__PURE__ */ __name2((s) => at(s, decodeURI), "bs");
var At = /* @__PURE__ */ __name2((s) => {
...
var vs = /* @__PURE__ */ __name2((s) => {
  const e = At(s);
  return e.length > 1 && e.at(-1) === "/" ? e.slice(0, -1) : e;
}, "vs");
var Ee = /* @__PURE__ */ __name2((s, e, ...t) => (t.length && (e = Ee(e, ...t)), `${(s == null ? void 0 : s[0]) === "/" ? "" : "/"}${s}${e === "/" ? "" : `${(s == null ? void 0 : s.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "Ee");
var Ot = /* @__PURE__ */ __name2((s) => {
...
var st = /* @__PURE__ */ __name2((s) => /[%+]/.test(s) ? (s.indexOf("+") !== -1 && (s = s.replace(/\+/g, " ")), s.indexOf("%") !== -1 ? at(s, jt) : s) : s, "st");
var Pt = /* @__PURE__ */ __name2((s, e, t) => {
  let r;
  if (!t && e && !/[%+]/.test(e)) {
    let a = s.indexOf(`?${e}`, 8);
...
var ws = Pt;
var Ss = /* @__PURE__ */ __name2((s, e) => Pt(s, e, true), "Ss");
var jt = decodeURIComponent;
var mt = /* @__PURE__ */ __name2((s) => at(s, jt), "mt");
var xe;
var V;
var se;
var Mt;
...
var It = (bt = class {
...
}, xe = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakSet(), Mt = /* @__PURE__ */ __name2(function(s) {
  const e = h(this, V)[0][this.routeIndex][1][s], t = O(this, se, nt).call(this, e);
  return t && /\%/.test(t) ? mt(t) : t;
}, "Mt"), Lt = /* @__PURE__ */ __name2(function() {
  ...
  return s;
}, "Lt"), nt = /* @__PURE__ */ __name2(function(s) {
  return h(this, V)[1] ? h(this, V)[1][s] : s;
}, "nt"), re = /* @__PURE__ */ new WeakMap(), bt);
var Es = { Stringify: 1 };
var Ft = /* @__PURE__ */ __name2(async (s, e, t, r, o) => {
...
var rt = /* @__PURE__ */ __name2((s, e) => ({ "Content-Type": s, ...e }), "rt");
var Le;
var Fe;
var Z;
var Ce;
...
var Rs = (vt = class {
  ...
  constructor(s, e) {
    ...
    E(this, "html", (s2, e2, t) => {
      const r = /* @__PURE__ */ __name2((o) => O(this, ne, Te).call(this, o, e2, rt("text/html; charset=UTF-8", t)), "r");
...
var As = /* @__PURE__ */ __name2((s) => s.text("404 Not Found", 404), "As");
var _t = /* @__PURE__ */ __name2((s, e) => {
  if ("getResponse" in s) {
...
var $t = (wt = class {
  ...
  route(e, t) {
    ...
    return t.routes.map((o) => {
      var a;
      let n;
      t.errorHandler === _t ? n = o.handler : (n = /* @__PURE__ */ __name2(async (c, i) => (await pt([], t.errorHandler)(c, () => o.handler(c, i))).res, "n"), n[Ds] = o.handler), O(a = r, L, ue).call(a, o.method, o.path, n);
    }), this;
  }
  basePath(e) {
  ...
  mount(e, t, r) {
    let o, n;
    r && (typeof r == "function" ? n = r : (n = r.optionHandler, r.replaceRequest === false ? o = /* @__PURE__ */ __name2((i) => i, "o") : o = r.replaceRequest));
    const a = n ? (i) => {
      const l = n(i);
    ...
    const c = /* @__PURE__ */ __name2(async (i, l) => {
...
}, K = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakSet(), kt = /* @__PURE__ */ __name2(function() {
...
}, "kt"), G = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ __name2(function(e, t, r) {
...
}, "ue"), Ve = /* @__PURE__ */ __name2(function(e, t) {
  if (e instanceof Error) return this.errorHandler(e, t);
  throw e;
}, "Ve"), Ke = /* @__PURE__ */ __name2(function(e, t, r, o) {
...
var Ht = [];
function Os(s, e) {
  const t = this.buildAllMatchers(), r = /* @__PURE__ */ __name2((o, n) => {
...
}, oe = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakSet(), qt = /* @__PURE__ */ __name2(function(s) {
  const e = [];
  let t = s === M;
...
}, ce = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), Oe = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakSet(), de = /* @__PURE__ */ __name2(function(s, e, t, r) {
  const o = [];
...
var yt = /* @__PURE__ */ __name2((s, e = qs) => {
...
var Ys = /* @__PURE__ */ __name2(async (s, e) => {
  let t;
...
var Xs = /* @__PURE__ */ __name2((s) => async function(t, r) {
  return Gs({ ...s, getContent: /* @__PURE__ */ __name2(async (n) => Ys(n, { manifest: s.manifest, namespace: s.namespace ? s.namespace : t.env ? t.env.__STATIC_CONTENT : void 0 }), "getContent") })(t, r);
}, "Xs");
var Gt = /* @__PURE__ */ __name2((s) => Xs(s), "Gt");
var it = 480 * 60 * 1e3;
function fe() {
...
// .wrangler/tmp/pages-Ac1UVe/avw5peqiho4.js
...
// .wrangler/tmp/bundle-SZV4OQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-SZV4OQ/middleware-loader.entry.ts
...
//# sourceMappingURL=avw5peqiho4.js.map
